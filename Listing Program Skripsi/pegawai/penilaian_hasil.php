...
?>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="w-100 mb-3 control-nilai">
                    ...
                    <input readonly class="only_number bg-white form-control" placeholder="belum dinilai" type="text"
                      name="penilaian[]" data-a-sep="." data-a-dec="," data-v-max="100" value="<?=$nilai?>">
                    <!-- <span class="ct-label">1 - 100</label> -->
                  </div>
                  <?php endforeach?>
                </div>
              ...
              <h6 class="text-left"><b>Penilaian bulan <?=get_nama_bulan($hist->bulan)?> tahun <?=$hist->tahun?></b>
              </h6>
