   ...
   <aside class="main-sidebar sidebar-light-primary elevation-0">
    ...
    <div class="sidebar">
      <div class=" px-2  pt-3 font-weight-light h4 mb-0" style="min-height: 100px">
        <div class="pt-1 small">Menu Direktur</div>
      </div>
      ...
      <li class="nav-item border-top">
        <a class="nav-link <?php echo (defined("ON_DASHBOARD")) ? 'active' : '' ; ?>" href="<?php echo base_url('users/direktur') ?>">
        <img class="img-icon" src="<?= base_url("assets/images/icon/home-outline.svg") ?>"><p>Beranda</p></a>
      </li> 

      <li class="nav-item border-top">
        <a class="nav-link <?php echo (defined("ON_DATA_PENGAJUAN")) ? 'active' : '' ; ?>" href="<?php echo base_url('users/direktur/data_pengajuan.php') ?>">
