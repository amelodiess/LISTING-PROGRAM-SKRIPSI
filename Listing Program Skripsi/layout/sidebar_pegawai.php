   ...
   <aside class="main-sidebar sidebar-light-primary elevation-0">
    ...
    <div class="sidebar">
      <div class=" px-2  pt-3 font-weight-light h4 mb-0" style="min-height: 100px">
        <div class="pt-1 small">Menu Pegawai</div>
      </div>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu"
        ...
        <li class="nav-item border-top">
          <a class="nav-link <?php echo (defined("ON_DASHBOARD")) ? 'active' : '' ; ?>" href="<?php echo base_url('users/pegawai') ?>">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo (defined("ON_HASIL_PENILAIAN")) ? 'active' : ''; ?>"
            href="<?php echo base_url('users/pegawai/penilaian_hasil.php') ?>">
